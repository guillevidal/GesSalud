...
import {
    ...
    RESETEAR_PACIENTES, RESETEAR_ESPECIALISTAS, MODIFICAR_PACIENTE, MODIFICAR_ESPECIALISTA, RESETEAR_MODIFICADO} from "./valuesForActions.js";
...
export const modificarPaciente = (paciente) => {
    return async (dispatch) => {
        {
            const result = await fetch(`http://localhost:3001/paciente/${paciente.id}`,
                {
                    method: "PUT",
                    headers: {
                        "Accept": "application/json",
...
export const modificarEspecialistas = (especialista) => {
    return async (dispatch) => {
        {
            const result = await fetch(`http://localhost:3001/especialista${especialista.id}`,
                {
                    method: "PUT",
                    headers: {
                        "Accept": "application/json",
